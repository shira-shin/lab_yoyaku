          ...
          <div className="rounded-2xl border bg-card p-0 overflow-hidden">
            <div className="border-b px-6 pt-4">
              <div className="flex gap-6">
                <span className="px-1 pb-3 -mb-px border-b-2 border-foreground font-medium">
                  ログイン
                </span>
                <Link
                  href="/groups/new"
                  className="px-1 pb-3 -mb-px border-b-2 border-transparent text-muted-foreground hover:text-foreground"
                >
                  新規作成
                </Link>
              </div>
